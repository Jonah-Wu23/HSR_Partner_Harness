...
- `v0.4.1-release-notes.md` — v0.4.1：修复桌面与手机会话中的动态消息排版、自动跟随和阅读位置保持；发布 Android arm64 与 Windows NSIS 安装包。当前产品基线。
- `v0.4.0-release-notes.md` — v0.4.0 正式版：角色卡创作与酒馆 v2/v3 JSON/PNG 双向兼容、自定义角色语音、手机远程与 Cloudflare Quick Tunnel、远程安全加固 D1–D7。
